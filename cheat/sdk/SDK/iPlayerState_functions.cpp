...
void IiPlayerState_C::GetNewPing()
{
	...
	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("iPlayerState_C", "GetNewPing");
...
void IiPlayerState_C::AddAssist(float DamageDone)
{
	...
	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("iPlayerState_C", "AddAssist");
...
void IiPlayerState_C::GetKills(int32* Kills)
{
	...
	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("iPlayerState_C", "GetKills");
...
void IiPlayerState_C::SetIsPlayerReady(bool bReady)
{
	...
	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("iPlayerState_C", "SetIsPlayerReady");
...
void IiPlayerState_C::IsPlayerReady(bool* bReady)
{
	...
	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("iPlayerState_C", "IsPlayerReady");
...
void IiPlayerState_C::GetName(class FText* PlayerName)
{
	...
	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("iPlayerState_C", "GetName");
...
void IiPlayerState_C::GetTeam(int32* Team)
{
	...
	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("iPlayerState_C", "GetTeam");
...
void IiPlayerState_C::SetTeam(int32 NewTeam)
{
	...
	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("iPlayerState_C", "SetTeam");
...
void IiPlayerState_C::AddScoreToPlayer(float ScoreToAdd, ERewardReasons ScoreReason)
{
	...
	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("iPlayerState_C", "AddScoreToPlayer");
...
void IiPlayerState_C::OnSuicide()
{
	...
	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("iPlayerState_C", "OnSuicide");
...
void IiPlayerState_C::AddDeath()
{
	...
	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("iPlayerState_C", "AddDeath");
...
void IiPlayerState_C::AddKill(bool TeamKill, bool Headshot)
{
	...
	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("iPlayerState_C", "AddKill");
